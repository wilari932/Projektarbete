...
namespace Projektarbete
{
    class MainForm : Form
    {
        ...
        public MainForm()
        {
            ...
            LeftMenuPanelBtnDelete = new Button { Text = "Delete", Dock = DockStyle.Fill, FlatStyle = FlatStyle.Flat, BackColor = Color.MediumVioletRed, Font = new Font("Arial", 12, FontStyle.Regular) };
            BtnPurchase = new Button { Text = "COMPLETE PURCHASE", Dock = DockStyle.Fill, FlatStyle = FlatStyle.Flat, BackColor = Color.MediumSeaGreen, Font = new Font("Arial", 12, FontStyle.Regular) };
